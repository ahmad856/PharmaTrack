...
function addProducts(quantity) {
  ...
  const pname = [ 'Cloud Service', 'Message Service', 'Add 2100 Service', 'Edit Service', 'Money' ];
  ...
  render() {
    return (
      <BootstrapTable data={ products } search={ true }>
          ...
          <TableHeaderColumn dataField='name' filterValue={ filterYear } dataFormat={ priceFormatter }>Product Year</TableHeaderColumn>
      </BootstrapTable>
    );
  }
}
