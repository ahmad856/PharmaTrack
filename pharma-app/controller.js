...
return{
	...
	get_all_medicines: function(req, res){
		console.log("getting all medicines from database: ");
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    // queryAllMedicine - requires no arguments , ex: args: [''],
		    const request = {
		        chaincodeId: 'pharma-app',
		        txId: tx_id,
		        fcn: 'queryAllMedicines',
		        args: ['']
		    };
	...
	get_medicine: function(req, res){

		console.log("get_medicine function called.");
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    // queryMedicine - requires 1 argument, ex: args: ['4'],
		    const request = {
		        chaincodeId: 'pharma-app',
		        txId: tx_id,
		        fcn: 'queryMedicine',
		...
		get_medicineDUMMY: function(req, res){

			console.log("get_medicineDUMMY function called.");
	...
	add_medicineDUMMY: function(req, res){
		console.log("submit recording of a medicine DUMMY: ");
		//console.log(req.body.post);
		//var array = req.body.post.split("-");
		//console.log(array);
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
				...
				const request = {
						...
						chaincodeId: 'pharma-app',
						fcn: 'recordMedicine',
						args: [Key, QRCode, Name, Description, Owner, AssetType, Price, ManufactureDate, ExpiryDate, Quantity, Timestamp],
						chainId: 'mychannel',
						txId: tx_id
	...
	change_owner: function(req, res){
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    // changeMedicineOwner - requires 2 args , ex: args: ['1', 'Barry'],
		    // send proposal to endorser
		    var request = {
		        //targets : --- letting this default to the peers assigned to the channel
		        chaincodeId: 'pharma-app',
		        fcn: 'changeMedicineOwner',
		        args: [key, owner],
		        chainId: 'mychannel',
		        txId: tx_id
		    };
		    ...
		    if (isProposalGood) {
		        ...
		        console.error('Failed to send Proposal or receive valid response. Response null or status is not 200. exiting...');
		        res.send("Error: no medicine found");
		        // throw new Error('Failed to send Proposal or receive valid response. Response null or status is not 200. exiting...');
		    }
		}).then((results) => {
		    console.log('Send transaction promise and event listener promise have completed');
		...
		change_ownerDUMMY: function(req, res){
			console.log("changing owner of medicine DUMMY: ");
		...
		get_historyDUMMY: function(req, res){

			console.log("get_historyDUMMY function called.");
