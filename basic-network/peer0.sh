...
export PEER_CONTAINER_NAME=peer0.org1.example.com
...
export RUN=/var/run/
export PEER_MSP_PATH=$PWD/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/msp
export PEER_PATH=$PWD/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com
